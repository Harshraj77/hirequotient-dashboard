      ...
      <div className="bg-white rounded-lg w-1/2 z-50">
        <form onSubmit={handleSubmit} className="p-8">
          ...
          <div className="flex justify-end">
            <button type="button" className="border border-gray-300 hover:bg-slate-200  font-bold py-2 px-4 rounded mr-2" onClick={handleClose}>Cancel</button>
            <button type="submit" className="bg-green-500 hover:bg-green-600 font-bold py-2 px-4 rounded">Save</button>
          </div>
        </form>
      </div>
    </div>
